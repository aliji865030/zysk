  ...
  return (
    <div className='flex flex-col justify-center items-center py-[4rem]'>
      <div className='w-[80%]'>
        ...
        <p className='text-[26px] font-medium'>Lastest blog posts</p>
      ...
      <div className='flex justify-center items-center gap-5 flex-wrap py-10'>
        {blog.map((item,index)=>{
            return(
                <div key={index} className='w-[400px] flex flex-col gap-3'>
      ...
      <div className='bg-[#f9fafb] flex flex-col justify-center items-center w-full gap-3 py-10'>
        ...
        <div className='flex justify-center items-center gap-5 mt-3'>
            <button className="bg-[#f9f9f9] border text-[14px] py-2 px-5 rounded-lg hover:bg-[#e3e2e4]">Learn more</button>
            <button className="bg-[#7f56d9] text-white text-[14px] py-2 px-5 rounded-lg hover:bg-[#673cc4]">Get started</button>
        </div>
      </div>
    </div>
  )
